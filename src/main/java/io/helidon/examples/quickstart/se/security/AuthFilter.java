...
public class AuthFilter implements Filter {
  public static final PathMatcher AUTHENTICATE = PathMatchers.create("/web/authenticate");
  public static final PathMatcher LOGOUT = PathMatchers.create("/web/logout");
  public static final PathMatcher REGISTER = PathMatchers.create("/web/register");
  ...
  private static final List<PathMatcher> EXCLUDED_PATHS = List.of(ROOT, AUTHENTICATE, REGISTER, LOGOUT, ASSETS, FILES);
